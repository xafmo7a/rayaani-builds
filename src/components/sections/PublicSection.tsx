      ...
      >
        ...
        <div className="p-5 md:p-8 md:pl-6">
          <div className="text-[13px] leading-[1.9] text-foreground/50 font-normal space-y-4">
            <p>
              While my perspective was forged in the dualities of <strong className="text-foreground font-semibold">Washington, D.C. and Baghdad</strong>, my professional life has been defined by the pursuit of excellence across borders. My connection to the U.S. capital began while my mother was completing her Master's degree in Fine Arts at <strong className="text-foreground font-semibold">Howard University</strong> and my father was working in the city; at only six months old, I was taken back to Iraq by my parents, where I was raised and eventually studied <strong className="text-foreground font-semibold">Architectural Engineering at the University of Baghdad (1984–1989)</strong>. Graduating with top honors, I was prepared for a career in design—but the <strong className="text-foreground font-semibold">1991 Gulf War</strong> changed everything.
            </p>
            <p>
              Driven by a <strong className="text-foreground font-semibold">hope larger than my fear</strong>, I left Iraq alone with no financial safety net. I first went to Germany, working at <strong className="text-foreground font-semibold">George Kinsky Architect</strong> in Frankfurt for $100 a month while painting and selling my artwork to sustain my journey. Upon arriving in the United States during an economic downturn, I accepted an <strong className="text-foreground font-semibold">unpaid internship</strong>, approaching even the simplest tasks with seriousness and gratitude.
            </p>
            <p>
              This persistence led to a scholarship through the <strong className="text-foreground font-semibold">Aga Khan Program at MIT and Harvard</strong>. At <strong className="text-foreground font-semibold">MIT (1992–1994)</strong>, I completed my <strong className="text-foreground font-semibold">Master of Science in Architectural Studies (SMArchS)</strong>, supporting myself as a teaching and research assistant. These years extended my focus into history, theory, and criticism—disciplines that sharpened the <strong className="text-foreground font-semibold">strategic approach to architectural leadership</strong> I carry today.
            </p>
            <p>
              In <strong className="text-foreground font-semibold">2004</strong>, I became a licensed architect in the State of New York and a <strong className="text-foreground font-semibold">LEED Accredited Professional</strong>. Those years built the foundation for the public impact that followed.
            </p>
          </div>
        </div>
      </div>
