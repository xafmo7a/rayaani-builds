...
const TwoColumn = ({ left, right }: { left: ColumnData; right: ColumnData }) => (
  ...
  >
    <div className="p-5 md:p-8">
      ...
      <h3 className="font-display text-[20px] font-normal text-foreground mb-3 leading-[1.3]">
        {left.heading}
      </h3>
      <div className="text-[12.5px] leading-[1.85] text-foreground/50 font-normal tracking-[0.015em]">
        {left.body}
      </div>
    </div>
    <div className="hidden md:block" style={{ background: "hsl(0 0% 12%)" }} />
    <div className="p-5 md:p-8 border-t md:border-t-0" style={{ borderColor: "hsl(0 0% 12%)" }}>
      <div className="text-[9px] font-semibold tracking-[0.28em] uppercase mb-3" style={{ color: "hsl(var(--aia-red))" }}>
        {right.tag}
      </div>
      <h3 className="font-display text-[20px] font-normal text-foreground mb-3 leading-[1.3]">
